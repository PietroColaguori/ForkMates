  ...
  if($_SESSION['loggedIn'] == true) {
    ...
    echo "<div class='topnav'>
        ...
        <div class=\"search-container\">
            <form ction=\"./ricerca_ricetta.php\" method=\"POST\"a>
...
<div class="container">
  <div class="row">
      <?php
            $search = $_POST['search'];
            $query = 'SELECT titolo, utente, difficulty, prep_time, cooking_time, people, image  FROM ricette WHERE titolo like \'%' .$search . '%\'';
            $result = pg_query($dbconn, $query);
